...
<button className="btn btn fa-solid fa-pen mt-2 d-grid gap-1 justify-content-md-end m-1" type="button pencil">
</button>
<button type="button" className="btn fa-solid fa-trash-can mt-2 d-grid gap-1 justify-content-md-end m-1" data-bs-toggle="modal" data-bs-target="#exampleModal">
</button>
{/* <!-- Modal --> */}
